...
class IpTvVM(private val repo: PaymentRepo, private val pojo: ContractPOJO) : BaseViewModel() {
    ...
    init {
        _finalDate.value = pojo.finalDate.getFormattedDate("dd.MM.yyyy", currentFormat = "d/MM/yyyy")

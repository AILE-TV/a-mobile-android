...
import com.ailetv.mobile.databinding.FragmentInternetBinding
...
class InternetFragment : BaseFragment() {
    private val safeArgs by navArgs<InternetFragmentArgs>()
    override val viewModel by viewModel<InternetVM> {
